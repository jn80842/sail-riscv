...
/-- Type quantifiers: k_ex375978# : Bool, level : Nat, k_ex375976# : Bool, k_ex375975# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex376023# : Bool, k_ex376022# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex376044# : Bool, k_ex376043# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex376080# : Bool, k_ex376079# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
