...
/-- Type quantifiers: k_ex103132# : Bool -/
...
/-- Type quantifiers: k_ex103133# : Bool -/
...
/-- Type quantifiers: k_ex103134# : Bool -/
...
/-- Type quantifiers: k_ex103136# : Bool -/
...
/-- Type quantifiers: k_ex103139# : Bool -/
...
/-- Type quantifiers: k_ex103141# : Bool -/
...
/-- Type quantifiers: k_ex103144# : Bool -/
...
/-- Type quantifiers: k_ex103146# : Bool -/
...
def zopz0zI_s (x : (BitVec k_n)) (y : (BitVec k_n)) : Bool :=
  dbg_trace s!"BLT {BitVec.toInt x} ({x}) < {(BitVec.toInt y)} ({y})"
