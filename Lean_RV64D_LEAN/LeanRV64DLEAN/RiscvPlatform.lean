...
def plat_ram_base (_ : Unit) : (BitVec 34) :=
  (to_bits physaddrbits_len (2147483648 : Int))

def plat_ram_size (_ : Unit) : (BitVec 34) :=
  (to_bits physaddrbits_len (2147483648 : Int))
...
def plat_rom_base (_ : Unit) : (BitVec 34) :=
  (to_bits physaddrbits_len (4096 : Int))

def plat_rom_size (_ : Unit) : (BitVec 34) :=
  (to_bits physaddrbits_len (4096 : Int))

def plat_clint_base (_ : Unit) : (BitVec 34) :=
  (to_bits physaddrbits_len (33554432 : Int))

def plat_clint_size (_ : Unit) : (BitVec 34) :=
