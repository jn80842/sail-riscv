...
/-- Type quantifiers: k_ex107556# : Bool, level : Nat, k_ex107554# : Bool, k_ex107553# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex107620# : Bool, k_ex107619# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex107644# : Bool, k_ex107643# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex107687# : Bool, k_ex107686# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
