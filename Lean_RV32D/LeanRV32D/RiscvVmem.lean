...
/-- Type quantifiers: k_ex373767# : Bool, level : Nat, k_ex373765# : Bool, k_ex373764# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex373812# : Bool, k_ex373811# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex373836# : Bool, k_ex373835# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex373875# : Bool, k_ex373874# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
