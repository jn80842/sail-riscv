...
/-- Type quantifiers: k_ex373991# : Bool, k_ex373990# : Bool, k_ex373989# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex374042# : Bool, k_ex374041# : Bool, k_ex374040# : Bool, width : Nat, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex374077# : Bool, k_ex374076# : Bool, k_ex374075# : Bool, width : Nat, is_mem_width(width) -/
