...
def plat_ram_base (_:Unit) : Arch.pa := Arch.pa.ofNat 0x80000000
def plat_ram_size (_:Unit) : Arch.pa := Arch.pa.ofNat 0x80000000
...
def plat_rom_base (_:Unit) : Arch.pa := Arch.pa.ofNat 0x1000
def plat_rom_size (_:Unit) : Arch.pa := Arch.pa.ofNat 0x100
def plat_htif_tohost (_:Unit) : Arch.pa := Arch.pa.ofNat 0x80001000 
def plat_clint_base (_:Unit) : Arch.pa := Arch.pa.ofNat 0x2000000
def plat_clint_size (_:Unit) : Arch.pa := Arch.pa.ofNat 0xc0000
